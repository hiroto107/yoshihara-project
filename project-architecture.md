# 冷泉荘くん × 山王マンションくん 対話UI機能 プロジェクト構成図
...
graph TB
    subgraph "フロントエンド"
        FE1[React + TypeScript + Vite]
        FE2[Tailwind CSS / Chakra UI]
        FE3[HTML5 Audio API]
        FE4[CSS / Lottie アニメーション]
    end
    
    subgraph "バックエンド"
        BE1[Mastra Framework]
        BE2[OpenAI GPT-4 LLM]
        BE3[ElevenLabs TTS]
        BE4[Vector Store RAG]
        BE5[REST API Mastra Server]
    end
