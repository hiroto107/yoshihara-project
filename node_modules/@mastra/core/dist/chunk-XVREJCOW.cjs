...
var MastraLLMV1 = class extends chunk6VOPKVYH_cjs.MastraBase {
  ...
  async __text({
    ...
    if (experimental_output) {
      ...
      if (chunk44ODA6L3_cjs.isZodType(experimental_output)) {
    ...
    const argsForExecute = {
      ...
      onStepFinish: async (props) => {
        ...
        if (props?.response?.headers?.["x-ratelimit-remaining-tokens"] && parseInt(props?.response?.headers?.["x-ratelimit-remaining-tokens"], 10) < 2e3) {
          ...
          await chunk44ODA6L3_cjs.delay(10 * 1e3);
        }
      },
  ...
  async __textObject({
    ...
    try {
      ...
      if (e instanceof chunkWM4VQWOZ_cjs.MastraError) {
        throw e;
      }
      const mastraError = new chunkWM4VQWOZ_cjs.MastraError(
        {
...
//# sourceMappingURL=chunk-XVREJCOW.cjs.map
//# sourceMappingURL=chunk-XVREJCOW.cjs.map