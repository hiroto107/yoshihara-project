...
https://mastra.ai/en/docs/memory/overview`
  ...
  getMergedThreadConfig(config) {
    ...
    const mergedConfig = chunk44ODA6L3_cjs.deepMerge(this.threadConfig, config || {});
  ...
  async addMessage({
    ...
    const list = new chunkAPY2BE4K_cjs.MessageList({ threadId, resourceId }).add(savedMessages[0], "memory");
...
//# sourceMappingURL=chunk-BV6CD4IZ.cjs.map
//# sourceMappingURL=chunk-BV6CD4IZ.cjs.map